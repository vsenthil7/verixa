...
> Document version: 1.0 · Date: 2026-05-10 · Status: Locked positioning
...
- **Reused IP:** Auditex (Hack0014) hash-commitment + triad reviewer pattern + EU AI Act mapping (~30% of code already shipped); SwarmScout (Hack0015) envelope-builder + on-chain anchor pattern
